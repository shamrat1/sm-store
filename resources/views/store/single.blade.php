...
<div class="w3l_banner_nav_right">
    ...
    <div class="agileinfo_single">
        ...
        <div class="col-md-8 agileinfo_single_right">
            ...
            <div class="snipcart-item block">
                <div class="snipcart-thumb agileinfo_single_right_snipcart">
                    <h4>${{ $product->unit_price }} <span></span></h4>
                </div>
        ...
        <div class="col-xs-12">
                <h1>Add Your Review to the Product</h1>
                {{ Form::open(['route'=>['review.store',$product->id], 'method'=>'POST']) }}
            ...
            <div class="rating1">
                    ...
                    {{ Form::submit('Add review',['class'=>'btn btn-success form-control','style'=>'margin-top:20px']) }}
                </div>
            </form>
        </div>
